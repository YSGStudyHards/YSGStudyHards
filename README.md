### 😎个人简介
一个热爱开源的全栈软件工程师，专注于 AI Vibe Coding 研发提效与大模型应用工程实践，擅长 C#、.NET、.NET Core、Golang、Vue、Angular 等相关技术开发。具备分布式、微服务应用，云原生应用，微信 Web 应用、小程序，H5 移动端应用，企业 Web 应用（ERP，CRM，OA 等系统）设计和开发经验。
